...
var EmployerSocialComponent = (function () {
    function EmployerSocialComponent(_employerPromiseService) {
        this._employerPromiseService = _employerPromiseService;
    }
    EmployerSocialComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    return EmployerSocialComponent;
}());
EmployerSocialComponent = __decorate([
    core_1.Component({
...
exports.EmployerSocialComponent = EmployerSocialComponent;
//# sourceMappingURL=employerSocial.component.js.map